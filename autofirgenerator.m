...
autofir_fc = 15000;     %cutoff frequency (hz)
autofir_N = 30;         %filter order (N+1 filter coefficients)

autofir_wordlength = 16;
autofir_fractions = 15; 
...
writetime =datestr(now,'yyddmm-HHMMSS');
