START_DIR = /Users/Johan/Documents/MATLAB

MATLAB_ROOT = /Applications/MATLAB_R2013b.app
MAKEFILE = testiir_mex.mk

include testiir_mex.mki
...
SRC_FILES =  \
	...
	testiir_api.c \
	testiir_mex.c \
	_coder_testiir_info.c

MEX_FILE_NAME_WO_EXT = testiir
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/testiir"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/testiir/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testiir/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testiir/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/testiir/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
